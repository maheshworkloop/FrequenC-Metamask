...
class SelectTicketAdapter(private val mList : List<EventTicket>,mListener : ListAdapterListener,
                          private val ticketType : String )  : RecyclerView.Adapter<SelectTicketAdapter.ViewHolder>() {
