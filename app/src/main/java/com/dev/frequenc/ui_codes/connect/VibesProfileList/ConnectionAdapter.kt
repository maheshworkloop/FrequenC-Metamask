...
class ConnectionAdapter(var mList: List<ConnectionResponse>,var isOnlineList : List<Boolean>, val mListener : ListAdapterListener) : RecyclerView.Adapter<ConnectionAdapter.ViewHolder> () {
