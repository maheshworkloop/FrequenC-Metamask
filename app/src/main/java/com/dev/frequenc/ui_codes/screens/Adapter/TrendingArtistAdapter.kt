...
class TrendingArtistAdapter (private val mList: List<TrendingArtistResponse>,
                             mListener: ListAdapterListener) : RecyclerView.Adapter<TrendingArtistAdapter.ViewHolder> (){
    ...
    interface ListAdapterListener{
       ...
       fun onClickAtArtist(item : TrendingArtistResponse)
